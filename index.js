...
function notesShow() {
    ...
    strnoteobj.forEach(function (element, index) {
        domShow += `  <div class="card text-dark bg-warning mb-3 mx-3 my-3" style="max-width: 18rem;">
        <div class="card-header">Note ${index + 1} <button type="button" class="btn-close" aria-label="Close"
                style="float: right;" id="deleteNote"></button></div>
        <div class="card-body">
